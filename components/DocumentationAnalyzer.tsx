...
// FIX: The `analyzeDocument` function is not exported directly. Use `analyzerService` instead.
...
import { UploadIcon, LinkIcon, LoadingIcon, SparklesIcon } from './icons/index';
