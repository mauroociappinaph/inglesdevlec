...
import { SparklesIcon, LoadingIcon, LightbulbIcon, CheckCircleIcon, XCircleIcon, ToneIcon, DiplomacyIcon, SuggestionIcon, InformalToneIcon, DirectToneIcon } from './icons/index';
// FIX: Functions are exported via service objects. Types should be imported from types.ts.
...
import PhraseCard from './lessons/PhraseCard'; // Using the new reusable PhraseCard
...
const GrammarTips: React.FC = () => {
    ...
    const handleExplain = async () => {
        ...
        setExplanation('');
        try {
            // FIX: Use contentService for getGrammarExplanation.
...
const ToneSpectrumChart: React.FC = () => {
    ...
    useEffect(() => {
        const fetchExamples = async () => {
            setIsLoading(true);
            // FIX: Use contentService for getToneExamples.
...
const PracticeZone: React.FC = () => {
    ...
    const handleNewScenario = async () => {
        ...
        setFeedback(null);
        setResponse('');
        // FIX: Use contentService for getDebateScenario.
    ...
    const handleGetFeedback = async () => {
        ...
        setFeedback(null);
        // FIX: Use feedbackService for getDebateFeedback.
