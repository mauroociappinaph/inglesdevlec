...
import KeyPhrases from "../lessons/KeyPhrases";
...
const interviewPhrases: KeyPhraseData[] = [
  {
    ...
    techContext:
      "A common behavioral question starter. Use the STAR method to structure your answer.",
  },
  {
    original: "I taught myself Python by building small projects every day.",
    translation:
      "Aprendí Python por mi cuenta construyendo pequeños proyectos todos los días.",
    techContext:
      "Shows initiative and a passion for learning. Be specific about the projects.",
  },
  {
    original: "I'm excited to learn new skills in this job.",
    translation:
      "Estoy emocionado/a por aprender nuevas habilidades en este trabajo.",
    techContext:
      "Expresses enthusiasm and a growth mindset, which are highly valued qualities.",
  },
  {
    ...
    techContext:
      "Use this to show long-term interest in the field. Follow up with a brief story.",
  },
  {
    original: "Could you tell me more about the team's culture?",
    translation: "¿Podría contarme más sobre la cultura del equipo?",
    techContext:
      "A great question to ask the interviewer. It shows you care about the work environment.",
  },
  {
    original: "What is the salary range for this position?",
    translation: "¿Cuál es el rango salarial para este puesto?",
    techContext:
      "It's appropriate to ask this, usually later in the interview process, to ensure expectations are aligned.",
  },
];
...
const StarMethodGuide: React.FC = () => (
  <div className="bg-primary-medium p-6 rounded-xl border border-primary-light">
    ...
    <p className="text-light-text mb-6">
      ...
      ("Tell me about a time when..."). It helps you create a clear, compelling
      story.
    </p>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="bg-primary-dark/50 p-4 rounded-md">
        ...
        <p className="text-sm mt-1 text-gray-400">
          Briefly describe the context. What was the project or challenge?
        </p>
      </div>
      <div className="bg-primary-dark/50 p-4 rounded-md">
        <h3 className="font-bold text-accent-yellow text-lg">T - Task</h3>
        <p className="text-sm mt-1 text-gray-400">
          What was your specific responsibility? What was the goal?
        </p>
      </div>
      <div className="bg-primary-dark/50 p-4 rounded-md">
        <h3 className="font-bold text-accent-pink text-lg">A - Action</h3>
        <p className="text-sm mt-1 text-gray-400">
          What specific steps did you take to address the task? Focus on "I,"
          not "we."
        </p>
      </div>
      <div className="bg-primary-dark/50 p-4 rounded-md">
        ...
        <p className="text-sm mt-1 text-gray-400">
          What was the outcome? Quantify your success with data or metrics if
          possible.
        </p>
      </div>
    </div>
...
const PracticeZone: React.FC = () => {
  ...
  const [isLoading, setIsLoading] = useState<"question" | "feedback" | null>(
    null
  );
  ...
  const handleGetFeedback = async () => {
    ...
    setFeedback("");
    const aiFeedback = await feedbackService.getInterviewFeedback(
      question,
      answer
    );
  ...
  return (
    <div className="bg-primary-medium p-6 rounded-xl border border-primary-light">
      ...
      >
        ...
        <span className="ml-2">
          {isLoading === "question" ? "Generating..." : "New Question"}
        </span>
      </button>
      ...
      {question && (
        <div className="animate-fade-in">
          ...
          >
            ...
            <span className="ml-2">
              {isLoading === "feedback" ? "Analyzing..." : "Get Feedback"}
            </span>
          </button>
        </div>
      )}
      ...
      {feedback && (
        <div className="mt-4 p-4 bg-primary-dark/50 rounded-md border border-primary-light animate-fade-in">
          ...
          <div
            className="prose prose-invert prose-sm max-w-none text-light-text"
    ...
    <div className="animate-fade-in space-y-8">
      <StudioGuide title="Guía de Estudio: Interview Practice">
        <div>
          ...
          <p>
            Prepararte para entrevistas de trabajo técnicas practicando frases
            clave y estructurando tus respuestas eficazmente.
          </p>
        </div>
        <div>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              Usa la "Practice Zone" para recibir una pregunta de entrevista al
              azar.
            </li>
            <li>
              Elabora tu respuesta y luego obtén feedback detallado del coach de
              IA.
            </li>
          </ul>
        </div>
        <div>
          ...
          <p>
            Practica respondiendo las preguntas en voz alta. Es muy diferente a
            pensar la respuesta en tu cabeza. Esto construye memoria muscular
      ...
      <div>
        ...
        <p className="text-lg text-gray-400">
          Domina las entrevistas técnicas en inglés con frases clave y práctica
          con IA.
        </p>
      </div>
